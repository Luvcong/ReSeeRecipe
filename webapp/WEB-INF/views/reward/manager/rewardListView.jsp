...
<body>
                	...
                	<c:choose>
   	                ...
   	                <tr>
	                    ...
	                    <tr>
	                        ...
	                        <td>${ reward.memId }</td>
	                        <td>${ reward.memNickname }</td>
	                        <td>${ reward.memGradeName }</td>
	                        <td>${ reward.rewardDate }</td>
	                        <td>${ reward.rewardReason }</td>
	                        <td>${ reward.rewardScore }</td>
	                        <td>${ reward.sumRewardScore }</td>
	                        <td style="display: none">${ reward.memNo }</td>
	                    </tr>
                			</c:forEach>
                		</c:otherwise>
                	</c:choose>
	...
	<div class="modal" id="updateRewardForm">
		<form method="post" action="${ pageContext.request.contextPath }/jhupdate.rw">
	...
	<!-- alertMsg script -->
 	<c:choose>
		<c:when test="${ successMsg ne null && not empty successMsg }">
			<script>
				Swal.fire('성공', '${successMsg}', 'success');
			</script>
		</c:when>
		<c:when test="${ failMsg ne null && not empty failMsg }">
			<script>
